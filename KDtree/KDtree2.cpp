...
inline bool
operator<(const kdtree2_result & e1, const kdtree2_result & e2)
{
...
// 
double
kdtree2_result_vector::max_value()
{
	return ((*begin()).dis);	// very first element
}

void
kdtree2_result_vector::push_element_and_heapify(kdtree2_result & e)
{
...
replace_maxpri_elt_return_new_maxpri(kdtree2_result & e)
{
...
void
kdtree2::spread_in_coordinate(int c, int l, int u, interval & interv)
{
...
void
kdtree2::select_on_coordinate(int c, int k, int l, int u)
{
	//
...
int
kdtree2::select_on_coordinate_value(int c, double alpha, int l, int u)
{
	//
...
void
kdtree2::n_nearest_brute_force(vector < double >&qv, int nn,
...
void
kdtree2::n_nearest_around_point(int idxin, int correltime, int nn,
								kdtree2_result_vector & result)
{
...
void
kdtree2::r_nearest(vector < double >&qv, double r2,
				   kdtree2_result_vector & result)
{
...
int
kdtree2::r_count(vector < double >&qv, double r2)
{
// search for all within a ball of a certain radius
	{
		kdtree2_result_vector result;
...
void
kdtree2::r_nearest_around_point(int idxin, int correltime, double r2,
								kdtree2_result_vector & result)
{
	vector < double >qv(dim);	//  query vector
...
int
kdtree2::r_count_around_point(int idxin, int correltime, double r2)
{
	vector < double >qv(dim);	//  query vector
...
inline double
dis_from_bnd(double x, double amin, double amax)
{
	if (x > amax)
	{
		return (x - amax);
