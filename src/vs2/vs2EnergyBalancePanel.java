...
public class vs2EnergyBalancePanel extends vs2ModelOptionsPanel {
     ...
     */
    public vs2EnergyBalancePanel(vs2ModelOptionsDialog parentDialog) {
        ...
        panel.setBorder(new CompoundBorder(
                BorderFactory.createTitledBorder("Output Options for Energy Balance"),
        ...
        rightPanel.add(inEnergyTotalCheckBox = new JCheckBox("Total Energy, In"));
        rightPanel.add(outEnergyTotalCheckBox = new JCheckBox("Total Energy, Out"));
        rightPanel.add(changeInEnergyStorageCheckBox = new JCheckBox("Change in Energy Storage"));
        rightPanel.add(energyBalanceCheckBox = new JCheckBox("Energy Balance"));
