...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getCellSizesAlongX(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jdx;
   double *dx;
   long nx;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getCellSizesAlongZ(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jdz;
   double *dz;
   long nz;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getTransport(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jc;
   double *c;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getKSat(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jksat;
   double *ksat;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getTexturalClassArray(JNIEnv *env, jclass obj, jintArray jvalue)
{
   jint *jtex;
   int *tex;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getMoistureContent(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getSaturation(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jsat;
   double *sat;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getPressureHead(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jphead;
   double *phead;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getTransportMassBalanceErrors(JNIEnv *env, jclass obj, jdoubleArray jvalue)
{
   jdouble *jerr;
   double *err;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getVx(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jvx;
   double *vx;
   long nx, nz, nn;
...
JNIEXPORT void JNICALL Java_vs2_vs2dt_getVz(JNIEnv *env, jclass obj, jfloatArray jvalue)
{
   jfloat *jvz;
   double *vz;
   long nx, nz, nn;
